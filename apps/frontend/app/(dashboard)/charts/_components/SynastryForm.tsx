  ...
  return (
    <div className="space-y-8">
      <form action={action} className="bg-white rounded-xl border border-stone-200 p-6 space-y-6">
        <h2 className="text-sm font-semibold text-stone-700 uppercase tracking-wider">Synastry Chart</h2>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Person 1 */}
          <div className="space-y-4 border border-stone-100 rounded-xl p-4">
            <h3 className="text-xs font-semibold text-stone-500 uppercase tracking-wider">Person 1</h3>
          ...
          {/* Person 2 */}
          <div className="space-y-4 border border-stone-100 rounded-xl p-4">
            <h3 className="text-xs font-semibold text-stone-500 uppercase tracking-wider">Person 2</h3>
        ...
        <button type="submit" disabled={pending}
          ...
          {pending ? "Calculating…" : "Calculate Synastry"}
        </button>
      </form>
