      ...
      <div className="rounded-2xl bg-white/80 backdrop-blur shadow-xl shadow-amber-900/10 border border-stone-200 p-8 space-y-6 text-sm text-stone-700">
        ...
        <section className="space-y-2">
          ...
          <p className="text-stone-600">
            ...
            можна скасувати будь-коли через Customer Portal — доступ до платних
            функцій зберігається до кінця оплаченого періоду. Платіж через monobank
            не потребує скасування: доступ просто закінчується через 30 днів,
            і ви можете продовжити його новим платежем у будь-який момент.
          </p>
        </section>
